...
//dbCore
var updateMany= require('../core/update');
//Projection utility
...
module.exports= function (input) {
	...
	input.model.updateMany= function (selector,obj) {
		...
		.then(function (obj) {
			return updateMany(obj[0],model.modelName,id2_id(model)(selector),obj[1],projectionUtil(model,{}));
		})
